 ...
 * created on 20/8/1.
 */
public class BaiduBaikeItem2TxtPipeline extends FilePersistentBase implements Pipeline {
    private Logger logger = LoggerFactory.getLogger(getClass());

    private File txtFile;

    public BaiduBaikeItem2TxtPipeline(String path, String txtFileName) {
        setPath(path+"image/");
    ...
    public void process(ResultItems resultItems, Task task) {
        ...
        BaiduBaikeDoc baikeDoc = resultItems.get("baikeDoc");
        write(baikeDoc);

        //TODO download  img
        downLoadImg(baikeDoc.picLinks.keySet(),baikeDoc.getDocId());
...
//            failedUrls.add(picUrl);
    ...
    public synchronized void write(BaiduBaikeDoc baikeDoc ) {
        //TODO  write jsonDOC
